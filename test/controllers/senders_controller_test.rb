...
class SendersControllerTest < ActionController::TestCase
  ...
  test "should create sender" do
    assert_difference('Sender.count') do
      post :create, sender: { certificate: @sender.certificate, cnpj: @sender.cnpj, name: @sender.name, nfe_sender: @sender.nfe_sender }
    end
  ...
  test "should update sender" do
    patch :update, id: @sender, sender: { certificate: @sender.certificate, cnpj: @sender.cnpj, name: @sender.name, nfe_sender: @sender.nfe_sender }
    assert_redirected_to sender_path(assigns(:sender))
  end
